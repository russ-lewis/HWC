#ifndef __SIM_BIT_STATE_H__INCLUDED__
#define __SIM_BIT_STATE_H__INCLUDED__



TODO: update this to reflect the new OverlapList structure, and limit this to just be the bit state list.
